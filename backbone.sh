...
sed -i "102s|http://127.0.0.1:5000/search|http://$tor_hostname/search|" scrapper/templates/scrapper.html
...
sed -i "183s|http://127.0.0.1:5001/search|http://$tor_hostname/search|" crawler/templates/crawler.html


sed -i "201s|http://127.0.0.1:5001/keyword|http://$tor_hostname/keyword|" crawler/templates/crawler.html
