...
\______ \   ____   ____  ____   __| _/____    /   _____/|  |__ _____ _______|  | __
 |    |  \_/ __ \_/ ___\/  _ \ / __ |/ __ \   \_____  \ |  |  \\__  \\_  __ \  |/ /
 |    `   \  ___/\  \__(  <_> ) /_/ \  ___/   /        \|   Y  \/ __ \|  | \/    < 
/_______  /\___  >\___  >____/\____ |\___  > /_______  /|___|  (____  /__|  |__|_ \
        \/     \/     \/           \/    \/          \/      \/     \/           \/
...
sudo bash requirements.sh || { echo -e "\e[1;31m[!] Error executing Requirements module.\e[0m"; exit 1; }

echo -e "\n"

echo -e "\e[1;33m[+] Executing Backbone module... \e[0m"
sudo bash backbone.sh || { echo -e "\e[1;31m[!] Error executing Backbone module.\e[0m"; exit 1; }
...
gnome-terminal --title="Scrapper Terminal" -- bash -c "$flask_command 2>&1 | tee $log_file; exec bash" || { echo -e "\e[1;31m[!] Error executing Scrapper module.\e[0m"; exit 1; }
...
gnome-terminal --title="Crawler Terminal" -- bash -c "$flask_command 2>&1 | tee $log_file; exec bash" || { echo -e "\e[1;31m[!] Error executing Crawler module.\e[0m"; exit 1; }

echo -e "\n"

echo -e "\e[1;33m[+] Starting PHP server \e[0m"
php_command="php -S 127.0.0.1:80"
